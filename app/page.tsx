...
import TabsWrapperZustand from "@/components/TabsWrapperZustand";
  ...
  return (
    <div className="flex-1 flex flex-col gap-20 max-w-4xl px-3">
      <main className="flex-1 flex flex-col gap-6">
          ...
          <p>
            Refresh me to see that the tab state is maintained. I use the URL to store state. Awesome right?
          </p>
          <p>
          ...
          <p>
            Below tabs use Zustand for state management.
          </p>
          <TabsWrapperZustand/>
